<div class="box box-default">
    ...
    <div class="box-header clearfix">
        <h4 class="box-title pull-left" style="padding-top: 7.5px;">
            {{ __('global.settings.general.title') }}
        </h4>
        ...
        <form id="frmGeneral" name="frmGeneral" 
            ...
            <div class="form-group">
                ...
                <label class="col-sm-2 control-label">
                    {{ __('global.settings.general.favicon') }}:
                </label>
                ...
                <div class="col-sm-8">
                    ...
                    {
                        $general_favicon_name = \App\Classes\Helper::timestampRemover($general_favicon_value);
                    }
                    @endphp
            ...
            <div class="form-group">
                ...
                <label class="col-sm-2 control-label">
                    {{ __('global.settings.general.logo_image') }}:
                </label>
                ...
                <div class="col-sm-8">
                    ...
                    {
                        $general_logo_name = \App\Classes\Helper::timestampRemover($general_logo_value);
                    }
                    @endphp
            ...
            <div class="form-group">
                ...
                <label class="col-sm-2 control-label">
                    {{ __('global.settings.general.profile_image') }}:
                </label>
                ...
                <div class="col-sm-8">
                    ...
                    {
                        $general_profil_image_name = \App\Classes\Helper::timestampRemover($general_profil_image_value);
                    }
                    @endphp
                    <input type="text" class="form-control" 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <!--
                    <input type="text" class="form-control" 
                           id="general_menu_bg_color_value" name="general_menu_bg_color_value" 
                           value="{{ $general_menu_bg_color_value }}">
                    -->
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <!--
                    <input type="text" class="form-control" 
                           id="general_header_bg_color_value" name="general_header_bg_color_value" 
                           value="{{ $general_header_bg_color_value }}">
                    -->
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <!--
                    <input type="text" class="form-control" 
                           id="general_panel_tab_color_value" name="general_panel_tab_color_value" 
                           value="{{ $general_panel_tab_color_value }}">
                    -->
                </div>
