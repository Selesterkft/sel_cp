...
<head>
    ...
    <title>@lang('global.global_sort_title') | @lang('global.login.title')</title>
        ...
        <div class="right">
            <div class="content">
                ...
                <form id="frmLogin" name="frmLogin"
                    ...
                    <div class="form-group">
                        <label for="email" class="form-label">
                            @lang('global.login.fields.email')
                        </label>
                    ...
                    <div class="form-group">
                        <label for="password" class="form-label">
                            @lang('global.login.fields.password')
                        </label>
                    ...
                    <a href="{{-- route('register') --}}"
                       id="goRight" class="btn btn-success">
                ...
                <div class="row">
                    ...
                    master_01@selester.com; 123456<br/>
                    master_02@selester.com; 123456<br/>
                    <!--user_01@selester.com; 123456<br/>
                    demo@raktarberlo.hu; ezajelszo123<br/>
                    email: info@selester.com;password: 123456<br/>
                    email: master_01@alg_transport.com<br/>
                    email: master_02@alg_transport.com<br/>
                    email: super_user_01@alg_transport.com<br/>
                    email: super_user_02@alg_transport.com<br/>
                    email: user_01@alg_transport.com<br/>
                    email: user_02@alg_transport.com<br/>-->
                </div>
