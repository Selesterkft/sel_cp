    ...
    public function run()
    {
        ...
        for($i = 1; $i <= 10; $i++)
        {
            $data[] = [
                ...
                'InvInDueDate' => $carbon, 'Net_LC' => 1000, 'Tax_LC' => 100, 'Brutto_LC' => 900, 'PayStatus' => 1,
                'Fully_paid_date' => null, 'PaidAmount_DC' => 0, 'PaidAmount_FC' => 0, 'PaidAmount_LC' => 0, 'Net_DC' => 1230,
                'Tax_DC' => 2342, 'Brutto_DC' => 13123, 'Lang' => 'H', 'Curr_ID' => 1405, 'Net_FC' => 11.233,
