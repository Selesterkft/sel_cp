...
class CreateInvTable extends Migration {
	...
	public function up()
	{
		Schema::create('Inv', function(Blueprint $table)
		{
			...
			$table->float('Netto_LC', 53, 0);
			$table->float('Tax_LC', 53, 0);
			$table->float('Brutto_LC', 53, 0);
			...
			$table->float('Netto_DC', 53, 0);
			$table->float('Tax_DC', 53, 0);
			$table->float('Brutto_DC', 53, 0);
			$table->string('Lang', 3);
			$table->integer('Curr_ID');
			$table->float('Netto_FC', 53, 0);
			$table->float('Tax_FC', 53, 0);
			$table->float('Brutto_FC', 53, 0);
